...
function PersonSkeleton() {
    return (
        <div className="min-h-screen bg-gradient-to-b from-[#0f172a] via-[#1e293b] to-[#0f172a] pt-24 animate-pulse">
                ...
                <div className="flex flex-col md:flex-row gap-10">
                    ...
                    <div className="flex-1 space-y-6">
                        ...
                        <div className="flex gap-3">
                            <div className="h-8 w-28 bg-indigo-600/30 rounded-full"></div>
...
export default function CastDetails() {
    ...
    if (error || !person) {
        return (
            <div className="min-h-screen bg-gradient-to-b from-[#0f172a] via-[#1e293b] to-[#0f172a] pt-24 flex items-center justify-center">
                <div className="text-center space-y-4">
                    ...
                    <Link to="/" className="inline-flex items-center gap-2 text-indigo-400 hover:text-indigo-300 transition-colors mt-4">
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-[#0f172a] via-[#1e293b] to-[#0f172a] pt-24 pb-16">
            <div className="container mx-auto px-4 md:px-8 lg:px-16">
                ...
                <div className="flex flex-col md:flex-row gap-10 lg:gap-14">
                    ...
                    <div className="flex-shrink-0 mx-auto md:mx-0">
                        <div className="relative w-[260px] sm:w-[280px] group">
                            <div className="absolute -inset-1 bg-gradient-to-br from-indigo-600/40 via-violet-500/20 to-lime-500/40 rounded-2xl blur-lg opacity-60 group-hover:opacity-80 transition-opacity duration-500"></div>
                            <div className="relative aspect-[2/3] rounded-2xl overflow-hidden ring-1 ring-white/15 shadow-2xl shadow-indigo-950/50">
                                {person.profileUrl ? (
                                    <img
                                    ...
                                    <div className="w-full h-full bg-gradient-to-br from-indigo-900/40 to-violet-900/40 flex items-center justify-center">
                                        <span className="text-6xl text-indigo-300/40 font-black">{person.name.charAt(0)}</span>
                                    </div>
                                )}
                            </div>
                        </div>
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        <div className="flex flex-wrap items-center gap-3 mb-8">
                            {person.knownFor && (
                                <span className="bg-gradient-to-r from-indigo-600 to-violet-600 text-white px-4 py-1.5 rounded-full text-sm font-semibold shadow-lg shadow-indigo-900/50 flex items-center gap-1.5">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 max-w-lg mb-8">
                            {person.birthday && (
                                <div className="bg-white/5 border border-white/8 rounded-xl px-4 py-3 flex items-center gap-3">
                                    <Cake className="w-4 h-4 text-indigo-400 flex-shrink-0" />
                                    <div>
                            ...
                            <div>
                                ...
                                {bioNeedsCollapse && (
                                    <button
                                        ...
                                        className="flex items-center gap-1 text-indigo-400 hover:text-indigo-300 transition-colors mt-3 text-sm font-medium"
                                    >
                                        {bioExpanded ? (
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-5">
                            {person.filmography.map((item) => (
                                <Link
                                    ...
                                    className="group"
                                >
                                    <div className="relative aspect-[2/3] rounded-xl overflow-hidden bg-white/5 ring-1 ring-white/10 group-hover:ring-indigo-500/40 transition-all duration-300 shadow-lg">
                                        {item.imageUrl ? (
                                            <img
                                                src={item.imageUrl}
                                                alt={item.title}
                                        ...
                                        <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300">
                                            <div className="bg-indigo-600 hover:bg-indigo-500 rounded-full p-3 transform scale-75 group-hover:scale-100 transition-transform duration-300 shadow-2xl shadow-indigo-900/50">
                                        ...
                                        {/* Type badge */}
                                        <div className="absolute top-2 left-2 bg-indigo-600/80 backdrop-blur-sm px-2 py-0.5 rounded-md">
                ...
                {/* Footer gradient */}
                <div className="h-16 bg-gradient-to-t from-[#0f172a] to-transparent mt-8"></div>
            </div>
        </div>
    );
}
